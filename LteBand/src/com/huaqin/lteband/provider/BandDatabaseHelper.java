 ...
 */
public /* package */ class BandDatabaseHelper extends SQLiteOpenHelper {
    ...
    private static BandDatabaseHelper sSingleton = null;
    //private final SyncStateContentProviderHelper mSyncState;
    private DatabaseUtils.InsertHelper mTodosInserter;

    public long todosInsert(ContentValues values) {
		LogUtils.d(TAG, "todosInsert()");
        return mTodosInserter.insert(values);
    }
    
    public static synchronized BandDatabaseHelper getInstance(Context context) {
		LogUtils.d(TAG, "TodosDatabaseHelper()");
        if (sSingleton == null) {
            sSingleton = new BandDatabaseHelper(context);
        }
        return sSingleton;
    }
     ...
     */
    BandDatabaseHelper(Context context) {
        super(context, DATABASE_NAME, null, DATABASE_VERSION);
        if (LOGD) {
            LogUtils.d(TAG, "Creating OpenHelper");
        }
    ...
    public void onOpen(SQLiteDatabase db) {
        ...
        mTodosInserter = new DatabaseUtils.InsertHelper(db, Tables.BAND);
    }
    ...
    private void bootstrapDB(SQLiteDatabase db) {
        LogUtils.d(TAG, "Bootstrapping database");
    ...
    private void createTodoTable(SQLiteDatabase db) {
        db.execSQL("CREATE TABLE " + Tables.BAND + " (" +
        		BandColumn.ID + " INTEGER PRIMARY KEY AUTOINCREMENT," +
        		BandColumn.SLOT_ID + " TEXT," +
        		BandColumn.SERVICE_STATE + " TEXT," +
        		BandColumn.CREATE_TIME + " INTEGER" +
                ");");
		LogUtils.d(TAG,"createTodoTable()");
    }

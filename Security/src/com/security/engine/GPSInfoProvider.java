	...
	public static synchronized GPSInfoProvider getInstance(Context context){
	  ...
	  public String getLocation()  
	    {  
	        ...
	        SharedPreferences sp = context.getSharedPreferences(SecurityInfoUtil.SHARED_OREFERENCE_LIB,
	        		Context.MODE_PRIVATE);  
	        String location = sp.getString(SecurityInfoUtil.GPS_LOCATION_RECORD, "");  
	        return location;  
	    }  
	    ...
	    {  
	        ...
	        {  
	            ...
	            editor.putString(SecurityInfoUtil.GPS_LOCATION_RECORD, latitude + " - " + longitude);  
	            editor.commit();  
	        }  
